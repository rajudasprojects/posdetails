	...
	<ul class="main-navigation">
	  ...
	  <li <?php if(strpos($curpage, 'ileupload')  != false) echo 'class="active"'; ?>><a href="javascript:void(0);">Data File Upload <span>&#9660;</span></a>
		<ul>
			...
			<li><a href="javascript:void(0);">QR</a>
				<ul>
					<li><a onclick="page_redirect('<?php echo $root; ?>qr/fileupload.php');" href="javascript:void(0);">File Upload</a></li>
					<li><a onclick="page_redirect('<?php echo $root; ?>qr/fileupload_summary.php');" href="javascript:void(0);">Confirm File</a></li>
					<li><a onclick="page_redirect('<?php echo $root; ?>qr/fileupload_rollback.php');" href="javascript:void(0);">Rollback</a></li>
				</ul>
			</li>
		</ul>
	  ...
	  <li <?php if(strpos($curpage, 'bill_certify') !== false) echo 'class="active"'; ?>><a href="javascript:void(0);">Bill Certify <span>&#9660;</span></a>
		<ul>
			...
			<li><a onclick="page_redirect('<?php echo $root; ?>qr/qr_bill_certify.php');" href="javascript:void(0);">QR</a></li>
		</ul>
	  </li>
	  <?php } ?>
	  ...
	  <li <?php if($curpage == "certification_exceptions.php" || $curpage == "daily_update.php") echo 'class="active"'; ?>><a href="javascript:void(0);">Certification Status <span>&#9660;</span></a>
		<ul>
			...
			<!--<li><a onclick="page_redirect('<?php echo $root; ?>../daily_status/bedl_it_resend.php');" href="javascript:void(0);">IT-RESEND</a></li>-->
			<li><a href="../daily_status/bedl_it_resend.php" target="_blank">IT-RESEND</a></li>
		</ul>
	  </li>
	  <li <?php if(strpos($curpage, 'mis_') !== false || (strpos($curpage, 'search') !== false && strpos($curpage, 'knumber_search') === false) || strpos($curpage, 'cancel_report') !== false) echo 'class="active"'; ?>><a href="javascript:void(0);">MIS <span>&#9660;</span></a>
		<ul>
			...
			<li><a href="javascript:void(0);">QR</a>
				<ul>
					<li><a onclick="page_redirect('<?php echo $root; ?>qr/mis_report.php');" href="javascript:void(0);">Report</a></li>
					<li><a onclick="page_redirect('<?php echo $root; ?>qr/search.php');" href="javascript:void(0);">Search</a></li>
				</ul>
			</li>
	  ...
	  <li <?php if($curpage == "cashofficecard_multimode_payments.php" || $curpage == "summary_report.php"  || $curpage == "kno_wise_report.php"  || $curpage == "non_energy_report.php"  || $curpage == "sms_report.php"  || $curpage == "non_cash_dclr_report.php") echo 'class="active"'; ?>><a href="javascript:void(0);">Report <span>&#9660;</span></a>
		<ul>
			...
			<li><a onclick="page_redirect('<?php echo $root; ?>reports/kno_wise_report_old.php');" href="javascript:void(0);">KNO Wise Old-Report</a></li>
