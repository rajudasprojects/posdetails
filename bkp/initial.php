...
if(isset($_POST['submit']) ? $_POST['submit'] : null)
{
	...
	if($sth->execute())
	{
		...
		$fail_msg = "Sorry you can't submit the blanck form!";
	}
...
<html>
	...
	<body>
		...
		<div style="color:red; margin:0px 20px 0px 450px; high:50px; font-size:25px; font-weight: bold;">
		<?php
		if(isset($fail_msg))
		{
			echo $fail_msg;
		...
		<form name="frm_entry" id="frm_entry" method="post" action="initial.php">
			<table style="margin-top:50px; background-color: #bcebfa;" class="custom-select1">
			
				<tr id="tr-bg">
					<td><label for="fname">Type:</label></td>
					<td>
				...
				<tr id="tr-bg">
						...
						<td>
							<textarea  type="text" name="job_desc" id="job_desc" rows="4" cols="30"></textarea>
						</td>
				...
				<tr id="tr-bg"><td colspan="4" style="text-align:center;"><input type="submit" name="submit" class="button1" value="SUBMIT"></td></tr>
			<table>
		</form>
