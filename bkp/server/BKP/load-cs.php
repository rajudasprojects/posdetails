...
if($_POST['tp']==""){
	...
	$query = $connpdo_treasry->prepare("select cashoffice_no,cashoffice_code,cashoffice_name,cashoffice_sup_ip,cashoffice_sup_pass,co_tel,cashoffice_address,co_switch_ip_1,co_switch_ip_2 from `treasury`.`cashoffice` where cashoffice_no is not null and co_op_status = '1' order by cashoffice_name");
	$query->execute();
	...
	$connpdo_treasry = null;
	$str="<option value='0'>Supervisor</option>";
