...
$sth = $connpdo_trclasic_dc->query("select pos_date,pos_no,batch_no, count(*) AS count_t from cashoffice.treasury_tran_batch WHERE typ_tranc ='1' AND pos_date >= '2024-07-09' AND pos_date <= '2024-07-12' AND st_status = '0' group by pos_date,pos_no,batch_no having count_t > 1");
$rows = $sth->fetchAll();
